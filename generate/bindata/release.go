...
func writeReleaseHeader(w io.Writer, c *configs.BindataConfig) error {
	var err error
	if c.NoCompress {
		if c.NoMemCopy {
...
func writeReleaseAsset(w io.Writer, c *configs.BindataConfig, asset *configs.Asset) error {
...
func compressedNoMemCopy(w io.Writer, asset *configs.Asset, r io.Reader) error {
...
func compressedMemCopy(w io.Writer, asset *configs.Asset, r io.Reader) error {
...
func uncompressedNoMemCopy(w io.Writer, asset *configs.Asset, r io.Reader) error {
	_, err := fmt.Fprintf(w, `var _%s = "`, asset.Func)
	if err != nil {
		return err
	}
...
func uncompressedMemCopy(w io.Writer, asset *configs.Asset, r io.Reader) error {
	_, err := fmt.Fprintf(w, `var _%s = []byte(`, asset.Func)
	if err != nil {
		return err
	}
...
func assetReleaseCommon(w io.Writer, c *configs.BindataConfig, asset *configs.Asset) error {
