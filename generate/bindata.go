...
func Bindata(c *configs.BindataConfig) error {
	...
	if _, err = fmt.Fprint(bfd, "// Code generated by forge bindata.\n"); err != nil {
		return err
	}
	...
	// Write assets.
	if c.Debug || c.Dev {
		err = bindata.WriteDebug(bfd, c, toc)
	} else {
		err = bindata.WriteRelease(bfd, c, toc)
	}
	...
	if err := bindata.WriteTOC(bfd, toc); err != nil {
		return err
	}
	// Write hierarchical tree of assets
	if err := bindata.WriteTOCTree(bfd, toc); err != nil {
		return err
	}

	// Write restore procedure
	return bindata.WriteRestore(bfd)
}
...
func findFiles(dir, prefix string, recursive bool, toc *[]configs.Asset, ignore []*regexp.Regexp, knownFuncs map[string]int, visitedPaths map[string]bool) error {
	dirpath := dir
	if len(prefix) > 0 {
